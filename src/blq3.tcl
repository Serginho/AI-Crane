...
proc PanelConfiguracionMundo { w pos } {
    ...
    set blq($pos,casilla,1,x)  20; set blq($pos,casilla,1,y)  20; set blq($pos,casilla,1,blq) 0
    set blq($pos,casilla,2,x)  20; set blq($pos,casilla,2,y)  50; set blq($pos,casilla,2,blq) 0
    set blq($pos,casilla,3,x)  20; set blq($pos,casilla,3,y)  80; set blq($pos,casilla,3,blq) 1
    set blq($pos,casilla,4,x)  60; set blq($pos,casilla,4,y)  20; set blq($pos,casilla,4,blq) 0
    set blq($pos,casilla,5,x)  60; set blq($pos,casilla,5,y)  50; set blq($pos,casilla,5,blq) 0
    set blq($pos,casilla,6,x)  60; set blq($pos,casilla,6,y)  80; set blq($pos,casilla,6,blq) 2
    set blq($pos,casilla,7,x) 100; set blq($pos,casilla,7,y)  20; set blq($pos,casilla,7,blq) 0
    set blq($pos,casilla,8,x) 100; set blq($pos,casilla,8,y)  50; set blq($pos,casilla,8,blq) 0
    set blq($pos,casilla,9,x) 100; set blq($pos,casilla,9,y)  80; set blq($pos,casilla,9,blq) 3

    set blq($pos,bloque,1) 3; set blq($pos,bloque,2) 6; set blq($pos,bloque,3) 9;
